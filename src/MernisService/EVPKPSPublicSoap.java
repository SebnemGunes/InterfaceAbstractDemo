...
public class EVPKPSPublicSoap
{
    ...
    public EVPKPSPublicSoap(){}

    public EVPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EVPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EVPExtendedSoapSerializationEnvelope envelope= new EVPExtendedSoapSerializationEnvelope(EVPExtendedSoapSerializationEnvelope.VER11);
