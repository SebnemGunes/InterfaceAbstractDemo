...
public class EVPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EVPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EVPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EVPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EVPDateTimeConverter dateTimeConverter = new EVPStandardDateTimeConverter();

    public EVPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EVPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EVPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EVPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EVPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EVPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
